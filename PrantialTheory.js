...
var init = () => {
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(2, currency, new ExponentialCost(90, Math.log2(10)));
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(3, currency, new ExponentialCost(90, Math.log2(10)));
    ...
    // c5
    {
        ...
        c5 = theory.createUpgrade(4, currency, new ExponentialCost(90, Math.log2(10)));
    ...
    // c6
    {
        ...
        c6 = theory.createUpgrade(5, currency, new ExponentialCost(90, Math.log2(10)));
    ...
    theory.createAutoBuyerUpgrade(2, currency, 1e12);
...
var getPrimaryEquation = () => {
    ...
    if (c1Exp.level == 1) result += "^{2}";
    if (c1Exp.level == 2) result += "^{3}";
    if (c1Exp.level == 3) result += "^{4}";

    result += "c_2";

    if (c2Exp.level == 1) result += "^{2}";
    if (c2Exp.level == 2) result += "^{3}";
    if (c2Exp.level == 3) result += "^{4}";

    return result;
}

var getSecondaryEquation = () => theory.latexSymbol + "=\\max\\rho";
var getPublicationMultiplier = (tau) => tau.pow(0.172) / BigNumber.THREE;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{0.172}}{3}";
